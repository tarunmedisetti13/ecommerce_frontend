...
const ProductDetail = () => {
  ...
  const rating = (Math.random() * (4.5 - 3.5)) + 3.5;
    ...
    <>
      ...
      <div className="mt-28 px-6 bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          {/* Left Side - Images */}
          <div className="flex gap-4 bg-white shadow-md md:sticky md:top-20 rounded-2xl">
            {/* Thumbnails */}
          ...
          <div className=" p-6 flex flex-col gap-4 overflow-y-auto max-h-[80vh] scrollbar-hide">
            ...
            <div className="flex justify-evenly gap-4 mt-4">
              <button className="uppercase px-5 py-2 bg-amber-400 rounded-xl w-40 h-12 font-semibold 
